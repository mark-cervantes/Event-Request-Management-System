      ...
      <v-row>
        ...
        <v-col cols="12">
          ...
          >
            ...
            Your event request is pending review. You will be notified once it's processed.
          </v-alert>
          ...
          >
            ...
            Unfortunately, your event request has been rejected. Please contact the office for more details.
          </v-alert>
